...
#define SORTLIST_ICON_TYPE_DRIVE	3
#define SORTLIST_ICON_TYPE_DOTDOT	2
#define SORTLIST_ICON_TYPE_DIR		1
#define SORTLIST_ICON_TYPE_FILE		0

class CSortListCtrl : public CListCtrl
{
// Construction
 BOOL m_classTypeIsFolder;		
public:
	CSortListCtrl();
...
// Operations
public:
	UINT SetFileIcon(CString s);
	BOOL SetHeadings( const CString& strHeadings );
	void SetClassFolderType(BOOL type){m_classTypeIsFolder = type;}
	BOOL GetClassFolderType(){ return m_classTypeIsFolder;}
	...
	DWORD GetItemFolderType(int nItem);
